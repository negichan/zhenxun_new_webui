...
<template>
    <div class="flex h-full w-full flex-col space-y-3 sm:space-y-4">
        <!-- 头部标题和统计 -->
        <div
            class="flex flex-col items-start justify-between gap-3 rounded-3xl bg-white p-4 shadow-sm border border-slate-200 sm:flex-row sm:items-center sm:gap-0"
        ...
        >
            <div
                class="rounded-3xl bg-white p-3 text-center shadow-sm border border-slate-200"
            >
