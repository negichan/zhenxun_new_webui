...
<template>
    <div class="flex w-full items-center justify-between">
        ...
        >
            <Folder class="h-5 w-5 text-zx-primary" />
            <span class="text-sm font-medium text-slate-700">文件管理</span>
        </div>
        <div class="flex items-center space-x-2">
            <button
                @click="showNewDialog = true"
                class="btn-touch flex cursor-pointer items-center space-x-2 rounded-full bg-zx-primary px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-zx-primary-hover"
            >
                <Plus class="h-4 w-4" />
